...
\setlrmarginsandblock{9mm}{13mm}{*}  	% {left}{right}{ratio}
...
\usepackage{psvectorian}						% Usato per inserire separatori
												% Vedere https://ctan.mirror.garr.it/mirrors/ctan/graphics/pstricks/contrib/pst-vectorian/doc/psvectorian.pdf
\newcommand{\separatoresinistro}{%
	\psvectorian[width=2em]{193}%
}
\newcommand{\separatoredestro}{%
	\psvectorian[width=2em,mirror]{193}%
}
\newcommand{\separatorestop}{%
	\begin{center}
		\separatoresinistro\quad\separatoredestro
	\end{center}%
}
\newcommand{\separatoretesto}[1]{%
	\begin{center}
		\separatoresinistro
...
\newcommand{\separatorefiori}{%
	\begin{center}
		\psvectorian[width=18em]{87}
	\end{center}
}
